...
<div className='grid grid-cols-4 px-16  mb-16 ml-10 max-sm:grid-cols-2 max-sm:gap-2 max-md:grid-cols-2 max-lg:grid-cols-3  max-md:px-0 max-xl:px-0 max-lg:px-0 '>
...
<div className='grid grid-cols-4 px-16  ml-10 max-sm:grid-cols-2 max-md:grid-cols-2 max-lg:grid-cols-3 max-md:px-0 max-xl:px-0 max-lg:px-0 '>
